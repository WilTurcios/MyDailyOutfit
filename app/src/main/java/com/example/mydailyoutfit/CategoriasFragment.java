...
public class CategoriasFragment extends Fragment {
    //CREACION DE VARIABLE PARA LA CARDVIEW DE CATEGORIA
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cardCategoria=view.findViewById(R.id.cardC1);
        //METODO PARA PASAR DE LA PANTALLA DE CATEGORIAS A GALERIA
        cardCategoria.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                GaleriaCatFragment galeriaCategoriasFragment = new GaleriaCatFragment();
                FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
                transaction.replace(R.id.fragment_container, galeriaCategoriasFragment);
